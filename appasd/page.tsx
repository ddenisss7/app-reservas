...
/* ── COMPONENTE DE MENÚ DESPLEGABLE (Mantenlo aquí o en otro archivo) ── */
...
function StatsSection() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-xs uppercase tracking-[0.3em] font-medium mb-5 text-gold">✦ Cifras que lo dicen todo ✦</p>
        <h2
    ...
    <div className="flex flex-col w-full">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-10 lg:px-28" style={{ maxWidth: "56rem", padding: "2.3rem" }}>
          ...
          <h1
            ...
            style={{ fontFamily: "var(--font-display)", fontSize: "clamp(3rem, 7vw, 6.5rem)", letterSpacing: "-0.03em" }}
          >
            La mesa perfecta,<br />
            <em style={{ color: "var(--accent-lit)", fontStyle: "italic" }}>cuando tú quieras</em>
          </h1>
          <p
      ...
      >
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] font-medium mb-6 text-gold">✦ Nuestra misión ✦</p>
            <h2
              className="font-black leading-tight"
              style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.2rem, 4vw, 3.8rem)", letterSpacing: "-0.02em" }}
            >
              Encuentra el restaurante{" "}
              <span style={{ color: "var(--accent-lit)", borderBottom: "3px solid rgba(225,29,72,0.35)", paddingBottom: "3px" }}>ideal</span>{" "}
              para cada momento
            </h2>
            <p
              className="leading-relaxed"
              style={{ color: "var(--muted)", fontSize: "1.05rem", marginTop: "1.75rem", maxWidth: "30rem" }}
            >
          ...
          <div className="relative">
            <div className="absolute -inset-3 rounded-3xl opacity-30 blur-2xl" style={{ background: "var(--accent)" }} />
            <img
      ...
      <section
        ...
        style={{ background: "var(--bg3)", padding: "9rem 5rem" }}
      >
        <div className="text-center mb-24 max-w-3xl mx-auto">
          <p className="text-xs uppercase tracking-[0.3em] font-medium mb-6 text-gold" style={{ textAlign: "center" }}>✦ Cómo funciona ✦</p>
          <h3
            className="font-bold leading-tight"
            style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem,4vw,3.5rem)", textAlign: "center" }}
          >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-start">
          <div className="space-y-12">
            {[
              ["01", "Explora nuestra selección", "Filtra por cocina, precio, ubicación o valoración y encuentra el restaurante que encaja con lo que buscas."],
              ...
              <div key={n} className="flex gap-7 items-start">
                <span
                  ...
                  style={{ fontFamily: "var(--font-display)", color: "var(--accent-lit)", opacity: 0.25 }}
                >{n}</span>
                <div>
